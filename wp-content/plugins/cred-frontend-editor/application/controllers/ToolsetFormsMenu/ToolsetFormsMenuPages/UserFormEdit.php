...
class UserFormEdit extends BasePage {

	const ID = 'CRED_User_Form_Edit';
	const SLUG = 'CRED_User_Form_Edit';
	...
	protected function meet_conditions() {
		...
		$this->conditions_met = (
			'post.php' === $pagenow
			&& $this->toolset_constants->constant( 'CRED_USER_FORMS_CUSTOM_POST_NAME' ) === get_post_type( toolset_getget( 'post' ) )
		);
