...
class PostFormNew extends BasePage {

	const ID = 'CRED_Form_New';
	const SLUG = 'CRED_Form_New';
	...
	protected function meet_conditions() {
		...
		$this->conditions_met = (
			...
			&& $this->toolset_constants->constant( 'CRED_FORMS_CUSTOM_POST_NAME' ) === toolset_getget( 'post_type' )
		);
	...
	public function get_slug() {
		...
		return $this->conditions_met
			? 'post-new.php?post_type=' . esc_html( $this->toolset_constants->constant( 'CRED_FORMS_CUSTOM_POST_NAME' ) )
			: '';
	}
