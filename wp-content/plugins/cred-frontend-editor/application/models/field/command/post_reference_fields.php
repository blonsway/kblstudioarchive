...
/**
 * Transform shortcode attributes to field object for rendering Types post reference selector fields.
 *
 * @since m2m
 */
class CRED_Field_Command_Post_Reference_Fields extends AbstractRelationshipCommand {

	const STATIC_FIELDS_INDEX = 'post_reference_fields';
	...
	public function execute() {
		...
		// No default value from URL parameter :-P
